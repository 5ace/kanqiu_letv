...
final class LoadAndDisplayImageTask implements Runnable {
	...
	public LoadAndDisplayImageTask(ImageLoaderEngine engine, ImageLoadingInfo imageLoadingInfo, Handler handler) {
		...
		thumbnailUtils = configuration.thumbnailUtils;
	...
	private Bitmap tryLoadBitmap() {
		...
		if(thumbnailUtils != null && uri.startsWith("LetvThumbnailUtils")){
			bitmap = thumbnailUtils.getThumbnailBitmap(uri.replace("LetvThumbnailUtils", ""));
			if(bitmap != null){
				return bitmap ;
			}
		}

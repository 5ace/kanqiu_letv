...
public final class DataStatistics {
	...
	public void sendPlayInfo(final Context context, final String p1, final String p2, final String ac,
		...
		mDataManager.sendPlayInfo(context, p1, p2, ac, err, pt, ut, uid, uuidTimeStamp, cid, pid, vid, vlen,
				retryCount, type, vt, url, ref, py, st, weid, pcode, ilu, ch,lc,lid);
	}
	/**
	...
	public void sendEnvInfo(final Context context, final String p1, final String p2, final String ip, final String xh,final boolean isplayer) {
		mDataManager.sendEnvInfo(context, p1, p2, ip, xh,isplayer);
	}
	/**
	...
	public String getStatLoginUrl() {
		if (isUseTest) {
//			return DataConstant.STAT_LOGIN_URL_TEST_xuxu;
...
//			return DataConstant.STAT_PLAYER_URL_TEST_xuxu;
		} else {
	...
	public String getStatActionUrl() {
		if (isUseTest) {
//			return DataConstant.STAT_ACTION_URL_TEST_xuxu;
	...
	public String getStatPVUrl() {
		if (isUseTest) {
//			return DataConstant.STAT_PV_URL_TEST_xuxu;
	...
	public String getStatEnvUrl() {
		if (isUseTest) {
//			return DataConstant.STAT_ENV_URL_TEST_xuxu;
	...
	public String getStatNewLoginUrl() {
		if (isUseTest) {
//			return DataConstant.STAT_LOGIN2_URL_TEST_xuxu;
	...
	public String getStatQueryUrl() {
		if (isUseTest) {
//			return DataConstant.STAT_QUERY_URL_TEST_xuxu;
	...
	public String getStatVideoCloseUrl() {
		if (isUseTest) {
//			return DataConstant.STAT_VIDEOCLOSED_URL_TEST_xuxu;
...
//			return DataConstant.STAT_ACTIONCODE_URL_TEST_xuxu;
		} else {
	...
	public String getUploadClientDataUrl() {
		if (isUseTest) {
//			return DataConstant.UPLOAD_CLIENTDATA_URL_xuxu;

...
public class PoolingClientConnectionManager implements BasicHttpClient {
	...
	public static HttpClient get(){
		...
		ConnManagerParams.setMaxConnectionsPerRoute(httpParams, new ConnPerRouteBean(CONN_PER_ROUTE_MAX));
		...
		HttpConnectionParams.setConnectionTimeout(httpParams, CONNECTION_TIMEOUT);//连接超时时间
		...
		DefaultHttpClient mHttpClient = new DefaultHttpClient(manager, httpParams);

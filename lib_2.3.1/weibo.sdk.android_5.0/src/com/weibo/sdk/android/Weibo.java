...
public class Weibo {
	...
	public static String app_key = "3830215581";//第三方应用的appkey
	public static String redirecturl = "http://m.letv.com";// 重定向url
...
//		CookieSyncManager.createInstance(context);
		startActivity(context, params, new WeiboAuthListener() {
			@Override
	...
	public void startDialog(Context context, WeiboParameters parameters,
		...
		if (accessToken != null && (accessToken.isSessionValid() == 1)) {
	...
	public void startActivity(Context context, WeiboParameters parameters,
			final WeiboAuthListener listener) {
		parameters.add("client_id", app_key);
		parameters.add("response_type", "token");
		parameters.add("redirect_uri", redirecturl);
		...
		if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
			...
			WeiboLoginActivity.Luanch(context, url, listener);
		}
	}
}

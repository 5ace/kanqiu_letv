...
public class DBManager {
	...
	private LiveSubscribeTraceHandler subscribeGameTrace = new LiveSubscribeTraceHandler(
			context);
	private LocalCacheTraceHandler localCacheTrace = new LocalCacheTraceHandler(
			context);
	private DialogMsgTraceHandler dialogMsgTrace = new DialogMsgTraceHandler(
			context);
	private PushAdImageTraceHandler pushAdImageTrace = new PushAdImageTraceHandler(
			context);

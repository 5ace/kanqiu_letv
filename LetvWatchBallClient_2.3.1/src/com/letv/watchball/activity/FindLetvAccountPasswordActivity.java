...
public class FindLetvAccountPasswordActivity extends PimBaseActivity implements
	...
	public static void launch(Activity context) {
		Intent intent = new Intent(context,
				FindLetvAccountPasswordActivity.class);
	...
	public void onClick(View v) {
		...
		case R.id.find_psw_by_email:
			LetvWebViewActivity.launch(FindLetvAccountPasswordActivity.this,
					LetvConstant.retrieve_pwd_byemail_url, getResources()
							.getString(R.string.find_pass_by_email));
			break;

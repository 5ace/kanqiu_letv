...
public class MainActivity extends SlidingFragmentActivity implements Icloseable {
    ...
    //------------------------------------------------------------
      ...
      public void onCreate(Bundle savedInstanceState) {
            ...
            DataStatistics.getInstance().sendLoginInfo(this, "0", "0", LetvUtil.getUID(), "-", "-", System.currentTimeMillis()/1000 +"", LetvUtil.getPcode(), 0);
...
//                    PreferencesManager.getInstance().isShowNewFeaturesDialog();
            if (isShow) {
                  new NewFeaturesDialog(this, new NewFeaturesDialog.NewFeaturesDialogListener() {
      ...
      public boolean onKeyDown(int keyCode, KeyEvent event) {
            ...
            if (keyCode == KeyEvent.KEYCODE_BACK) {
                  ...
                  if (!getSlidingMenu().isMenuShowing() && manager.closeNewsFilter()) {
                        new AlertDialog.Builder(this).setTitle(R.string.dialog_eixt_title).setMessage(R.string.dialog_eixt_msg)
                                .setPositiveButton(R.string.dialog_eixt_yes, new OnClickListener() {

                                      @Override
                                      public void onClick(DialogInterface dialog, int which) {
                                            finish();
                                      }
                                }).setNegativeButton(R.string.dialog_eixt_no, null).show();
                        return true;
                  }
            }
      ...
      private void checkUpdateVersionInfo() {
            ...
            if (mDataStatusInfo != null) {
                  ...
                  if (mUpgradeInfo != null && UpgradeInfo.UPGRADE_YES.equals(mUpgradeInfo.getUpgrade())) {
                        ...
                        isForceUpdate = UpgradeInfo.UPTYPE_FORCE.equals(mUpgradeInfo.getUptype());
                        showUpdateDialog(mUpgradeInfo, isForceUpdate);
                  } else {
                        PreferencesManager.getInstance().setIsNeedUpdate(false);
                  }
//			showUpdateDialog(mUpgradeInfo, mUpgradeInfo.getUptype().equals(UpgradeInfo.UPTYPE_FORCE));
            }
      }
       ...
       * @param isForceUpdate
       */
      private void showUpdateDialog(final UpgradeInfo result, boolean isForceUpdate) {
                  ...
                  UIs.call(MainActivity.this, result.getTitle(), result.getMsg(),
                          ...
                          new OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                      dialog.dismiss();
                                      try {
                                            new UpdateDownloadAsyncTask(MainActivity.this, result.getUrl(),
                                                    result.getV(), result.getUptype(),mHandler).execute();
                  ...
                  UIs.call(MainActivity.this, result.getTitle(), result.getMsg(),
                          ...
                          new OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                      ...
                                      try {
                                            new UpdateDownloadAsyncTask(MainActivity.this, result.getUrl(),
                                                    result.getV(), result.getUptype()).execute();
                                      } catch (UpdataAppException e) {
                                            e.printStackTrace();
                                      }
                                }
      ...
      private void setUtp() {
            ...
            if (PreferencesManager.getInstance().getUtp()) {
                  ...
                  try {
                        p2pService.startService(this, 6990,"cache.max_size=20M&downloader.pre_download_size=10M&enable_android_log=false&app_id=70");

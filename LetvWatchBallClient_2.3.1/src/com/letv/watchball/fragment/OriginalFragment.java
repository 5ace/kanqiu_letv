...
public class OriginalFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			view = inflater.inflate(R.layout.original_fragment, container,
					false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (getView() != null) {
			original_fragment_title_tag = (TextView) getView().findViewById(
					R.id.original_fragment_title_tag);
			original_fragment_videoList = (OriginalVideoListFragment) getActivity()
					.getSupportFragmentManager().findFragmentById(
							R.id.original_fragment_videoList);
			getView().findViewById(R.id.toggle_left).setOnClickListener(
					new OnClickListener() {

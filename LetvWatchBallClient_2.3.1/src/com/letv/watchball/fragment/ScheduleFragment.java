...
public class ScheduleFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			view = inflater.inflate(R.layout.schedule_fragment, container,
					false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (getView() != null) {
			schedule_fragment_title_tag = (TextView) getView().findViewById(
					R.id.schedule_fragment_title_tag);
			schedule_fragment_title_radioGroup = (RadioGroup) getView()
					.findViewById(R.id.schedule_fragment_title_radioGroup);
			schedule_fragment_radio_video = (RadioButton) getView()
					.findViewById(R.id.schedule_fragment_radio_video);
			schedule_fragment_radio_schedule = (RadioButton) getView()
					.findViewById(R.id.schedule_fragment_radio_schedule);
			schedule_fragment_radio_ranker = (RadioButton) getView()
					.findViewById(R.id.schedule_fragment_radio_ranker);

			schedule_fragment_group_video = (EventsVideoNewsFragment) getActivity()
					.getSupportFragmentManager().findFragmentById(
							R.id.schedule_fragment_group_video);
			schedule_fragment_group_schedule = (GScheduleListFragment) getActivity()
					.getSupportFragmentManager().findFragmentById(
							R.id.schedule_fragment_group_schedule);
			schedule_fragment_group_rank = (RankerFragment) getActivity()
					.getSupportFragmentManager().findFragmentById(
							R.id.schedule_fragment_group_rank);

			schedule_fragment_title_radioGroup
					.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
						...
						public void onCheckedChanged(RadioGroup group,
							...
							if (checkedId == R.id.schedule_fragment_radio_video) {
								...
								schedule_fragment_group_video.getView()
										.setVisibility(View.VISIBLE);
								schedule_fragment_group_schedule.getView()
										.setVisibility(View.GONE);
								schedule_fragment_group_rank.getView()
										.setVisibility(View.GONE);
								...
								schedule_fragment_group_schedule
										.setMatch(match);
			...
			getView().findViewById(R.id.evnet_toggle_left).setOnClickListener(
					new OnClickListener() {
	...
	public void setMatch(Match match) {
		...
		schedule_fragment_title_radioGroup
				.check(R.id.schedule_fragment_radio_video);
	}
	...
	public void onDestroyView() {
		...
		if (null != fragment && !ft.isEmpty()) {
			...
			ft.remove(schedule_fragment_group_schedule)

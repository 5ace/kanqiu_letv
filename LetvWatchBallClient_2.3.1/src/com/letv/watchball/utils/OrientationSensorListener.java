		...
		if (requestedOrientation == 4) {//初始化为根据重力，所以在这里纠正方向
			...
			if (rt == Surface.ROTATION_0) {
				if (rotateHandler != null) {
					rotateHandler.obtainMessage(ChangeOrientationHandler.ORIENTATION_1).sendToTarget();
				}
				...
				if (rotateHandler != null) {
					rotateHandler.obtainMessage(ChangeOrientationHandler.ORIENTATION_9).sendToTarget();
				}

...
public class LocalCacheBean {
	...
	public LocalCacheBean(String cacheId, String markId, String cacheData, long cacheTime) {
		super();
		this.cacheId = cacheId;
		this.markId = markId;
		this.cacheData = cacheData;
	...
	public String toString() {
		return "LocalCacheBean [cacheId=" + cacheId + ", markId=" + markId + ", cacheData="
				+ cacheData.length() + ", cacheTime=" + cacheTime + "]";
	}

...
/**
 * 用户信息对象 请求： {@link LetvHttpApi#login(int updataId , String loginname , String
 * password , String registService , String profile ,LetvMainParser<T, D>
 * parser)} {@link LetvHttpApi#requestUserInfo(int updataId , String uid ,
 * LetvMainParser<T, D> parser)} 解析： {@link com.letv.watchball.parse.UserParser}
 * */

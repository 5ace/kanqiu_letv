...
public class LetvThumbnailImpl implements LetvThumbnailUtils {
	...
	public Bitmap getThumbnailBitmap(String path){
		if(NativeInfos.getSupportLevel() == NativeInfos.SUPPORT_MP4_LEVEL || !NativeInfos.ifSupportVfpOrNeon()) {
			return com.letv.watchball.bean.LetvThumbnailUtils.getThumbnailBitmap(path);
		} else {

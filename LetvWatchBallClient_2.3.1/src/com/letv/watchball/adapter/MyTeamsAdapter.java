...
public class MyTeamsAdapter extends BaseAdapter {
	...
	public View getView(final int Position, View convertView, ViewGroup arg2) {
		...
		if(convertView==null){
			...
			holder.icon = (LetvImageView) convertView.findViewById(R.id.child_icon);
			holder.focusSwitcher = (ImageView) convertView.findViewById(R.id.focus_switcher);
		...
		holder.focusSwitcher.setImageResource(R.drawable.myfocus_item_child_add_sel);
			...
			holder.focusSwitcher.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(LetvUtil.hasNet()) {
						...
						new RequestUnfocus(MainActivity.getInstance(), team.teamId+"", team.level, new Runnable() {
			...
			holder.focusSwitcher.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(LetvUtil.hasNet()) {
						...
						new RequestFocus(MainActivity.getInstance(), team.teamId+"", team.level, new Runnable() {

...
//	private static final String STATIC_APP_BASE_HEAD = "http://static.app.m.letv.com/android";
	...
	/************************************************* 看球      正式地址 ********************************************************/
//	public static final String BASE_URL = "http://220.181.153.236:8080/sports/api/";
      /**
	 * 看球1.0正式接口
	 */
	 ...
	 * 静态请求head
	 * */
//	private static final String WB_STATIC_BASE_HEAD = "http://static.sports.m.letv.com";
	...
	private static String getWbAPI10() {
      ...
      public static LetvDataHull<AdJoiningBean> requestAdJoining(int i, String ahl, String vl, String atl, AdJoiningParser adJoiningParser) {
            return null;
      }
      ...
      public static interface REQUEST_URL {
		...
		public String vrsVideos_match = getWbAPI10() + "/android/mod/minfo/ctl/videolist/act/index";
	 ...
	 * 根据参数，调起请求
	 * */
	private static <T extends LetvBaseBean, D> LetvDataHull<T> request(LetvHttpBaseParameter<T, D, ?> httpParameter) {
...
//	 * 根据参数，调起请求
//	 * */
//	private static <T extends LetvBaseBean, D> LetvDataHull<T> request(LetvHttpParameter<T, D> httpParameter) {
//		LetvHttpTool<T> handler = new LetvHttpTool<T>();
//
//		return handler.requsetData(httpParameter);
//	}
	 ...
	 * 
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestAllLiveinfos(LetvBaseParser<T, D> parser) {

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.allliveinfos, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * 
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestLiveinfos(String page_index, LetvBaseParser<T, D> parser) {

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(LIVE_INFOS.page_index, page_index);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.liveinfos, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestMatchlist(boolean respOriginalProgram, LetvBaseParser<T, D> parser) {

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(MATCH_LIST.original_colunm, (respOriginalProgram ? 1 : 0) + "");
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.match_list, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestOriginalVideo(String columnId, int offset, int max, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		...
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.original_video, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestVideoTypes(LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.video_types, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestSubscribeMatch(String matchId, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
...
//		params.putString(SUBSCRIBE_MATCH.token, "");
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.subscribe_match, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestUnsubscribeMatch(String matchId, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(PUBLIC_PARAMETERS.DEVICE_ID, DEVICEID);
		params.putString(SUBSCRIBE_MATCH.matchId, matchId);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.unsubscribe_match, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestMatchSchedule(String match_type, String round_key, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		...
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.match_schedule, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestTable(String match_type, String level, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		...
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.table, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestGetFocusTeam(LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(PUBLIC_PARAMETERS.DEVICE_ID, DEVICEID);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.getFocusTeam, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestFocus(String teamId, String level, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(PUBLIC_PARAMETERS.DEVICE_ID, DEVICEID);
		...
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.focus, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestUnfocus(String teamId, String level, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(PUBLIC_PARAMETERS.DEVICE_ID, DEVICEID);
		params.putString(FOCUS.teamId, teamId);
		params.putString(FOCUS.level, level);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.unfocus, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestMyTeamMatch(String teamId, String level, LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(PUBLIC_PARAMETERS.DEVICE_ID, DEVICEID);
		params.putString(FOCUS.teamId, teamId);
		params.putString(FOCUS.level, level);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.my_team_match, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestAllMyTeamMatchs(LetvBaseParser<T, D> parser) {
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(PUBLIC_PARAMETERS.DEVICE_ID, DEVICEID);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.my_all_matches, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestMyTeams(LetvBaseParser<T, D> parser){
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(PUBLIC_PARAMETERS.DEVICE_ID, DEVICEID);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.my_teams, params, LetvHttpParameter.Type.GET, parser, 0);
		return request(httpParameter);
	}
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestMatchInfo(String id, LetvBaseParser<T, D> parser){
		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		params.putString(MATCH_INFO.id, id);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(REQUEST_URL.match_info, params, LetvHttpParameter.Type.GET, parser, 0);
	 ...
	 * parser   解析器
	 * @return
	 * XDataHull<T> 壳数据  1.大陆 0.海外
	 * */
	public static <T extends LetvBaseBean , D> LetvDataHull<T> requestIP(int updataId , LetvMainParser<T, D> parser){
		String baseUrl = IP_BASE_URL ;
		
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(baseUrl, null, LetvHttpParameter.Type.GET , parser, updataId);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> submitPlayTrace(int updataId, String cid, String pid, String vid, String nvid, String uid,
			String vtype, String from, String htime, String sso_tk, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, SUBMITPLAYTRACE_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, SUBMITPLAYTRACE_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, SUBMITPLAYTRACE_PARAMETERS.ACT_VALUE);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> submitPlayTraces(int updataId, String uid, String data, String sso_tk, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl() + "?" + PUBLIC_PARAMETERS.MOD_KEY + "=" + SUBMITPLAYTRACES_PARAMETERS.MOD_VALUE + "&" + PUBLIC_PARAMETERS.CTL_KEY
				+ "=" + SUBMITPLAYTRACES_PARAMETERS.CTL_VALUE + "&" + PUBLIC_PARAMETERS.ACT_KEY + "=" + SUBMITPLAYTRACES_PARAMETERS.ACT_VALUE + "&"
				+ PUBLIC_PARAMETERS.PCODE_KEY + "=" + PCODE + "&" + PUBLIC_PARAMETERS.VERSION_KEY + "=" + VERSION;
		...
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(baseUrl, params, LetvHttpParameter.Type.POST, parser, updataId);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> deletePlayTraces(int updataId, String pid, String vid, String uid, String idstr, String flush,
			String backdata, String sso_tk, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, DELETEPLAYTRACES_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, DELETEPLAYTRACES_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, DELETEPLAYTRACES_PARAMETERS.ACT_VALUE);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> getPlayTraces(int updataId, String uid, String page, String pagesize, String sso_tk,
			LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, GETPLAYTRACES_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, GETPLAYTRACES_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, GETPLAYTRACES_PARAMETERS.ACT_VALUE);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> getPlayTrace(int updataId, String uid, String vid, String sso_tk, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, GETPLAYTRACE_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, GETPLAYTRACE_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, GETPLAYTRACE_PARAMETERS.ACT_VALUE);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> searchPlayTraces(int updataId, String pids, String vids, String sso_tk,
			LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, SEARCHPLAYTRACES_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, SEARCHPLAYTRACES_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, SEARCHPLAYTRACES_PARAMETERS.ACT_VALUE);
	 ...
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestAlbumVideoInfo(int updataId, String id, String type, String markId,
			LetvMainParser<T, D> parser) {
		...
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, VIDEO_INFO_PARAMETERS.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, type));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, VIDEO_INFO_PARAMETERS.ACT_VALUE));
		...
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.VERSION_KEY, VERSION));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MARKID_KEY, markId));

		LetvHttpStaticParameter<T, D> httpParameter = new LetvHttpStaticParameter<T, D>(head, end, params, parser, updataId);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestAlbumVideoList(int updataId, String id, String vid, String page, String count, String o,
			String merge, String markId, LetvMainParser<T, D> parser) {
		String head = getStaticHead();// STATIC_TEST_BASE_HEAD2;
		String end = getStaticEnd();// STATIC_TEST_BASE_END2;

		ArrayList<BasicNameValuePair> params = new ArrayList<BasicNameValuePair>();

		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, VIDEOS_LIST_PARAMETERS.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, VIDEOS_LIST_PARAMETERS.CTL_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, VIDEOS_LIST_PARAMETERS.ACT_VALUE));
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestVideoFile(int updataId, String mmsid, String playid, String tss, String tm, String key,
			LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, VIDEO_FILE_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, VIDEO_FILE_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, VIDEO_FILE_PARAMETERS.ACT_VALUE);
	 ...
	 * 得到时间戳
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> getTimestamp(int updataId, LetvMainParser<T, D> parser) {
	 ...
	 * 得到过期时间戳
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> getExpireTimestamp(int updataId, LetvMainParser<T, D> parser) {

		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, EXPIRE_TIMESTAMP_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, EXPIRE_TIMESTAMP_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, EXPIRE_TIMESTAMP_PARAMETERS.ACT_VALUE);
		params.putString(PUBLIC_PARAMETERS.PCODE_KEY, PCODE);
		params.putString(PUBLIC_PARAMETERS.VERSION_KEY, VERSION);
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestRealLink(int updataId, String url, LetvMainParser<T, D> parser) {
		/**
		...
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(builder.toString(), null, LetvHttpParameter.Type.GET, parser, updataId);
		return request(httpParameter);
	}
	 ...
	 * @return
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestShareLink(int updataId, LetvMainParser<T, D> parser) {
		...
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, SHARE_PARAMETERS.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, SHARE_PARAMETERS.CTL_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, SHARE_PARAMETERS.ACT_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.PCODE_KEY, PCODE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.VERSION_KEY, VERSION));
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> openIDOAuthLogin(int updataId, String baseUrl, LetvMainParser<T, D> parser) {
		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(baseUrl, null, LetvHttpParameter.Type.GET, parser, updataId);
		return request(httpParameter);
	}
	/**
	 ...
	 * @return
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestDialogMsgInfo(int updataId, String markid, LetvMainParser<T, D> parser) {
		// http://static.app.m.letv.com/android/mod/minfo/ctl/message/act/index/pcode/{$pcode}/version/{$version}.mindex.html
		String head = getStaticHead();
		String end = getStaticEnd();
		ArrayList<BasicNameValuePair> params = new ArrayList<BasicNameValuePair>();

		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, DIALOG_PARAMETERS.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, DIALOG_PARAMETERS.CTL_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, DIALOG_PARAMETERS.ACT_VALUE));
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestUserInfo(int updataId, String uid, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, GETUSERBYID_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, GETUSERBYID_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, GETUSERBYID_PARAMETERS.ACT_VALUE);
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestUserInfoByTk(int updataId, String tk, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, GETUSERBYTK_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, GETUSERBYTK_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, GETUSERBYTK_PARAMETERS.ACT_VALUE);
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> login(int updataId, String loginname, String password, String registService, String profile,
			LetvMainParser<T, D> parser) {

		String baseUrl = getDynamicUrl() + "?" + PUBLIC_PARAMETERS.MOD_KEY + "=" + CLIENTLOGIN_PARAMETERS.MOD_VALUE + "&" + PUBLIC_PARAMETERS.CTL_KEY + "="
				+ CLIENTLOGIN_PARAMETERS.CTL_VALUE + "&" + PUBLIC_PARAMETERS.ACT_KEY + "=" + CLIENTLOGIN_PARAMETERS.ACT_VALUE + "&"
				+ PUBLIC_PARAMETERS.PCODE_KEY + "=" + PCODE + "&" + PUBLIC_PARAMETERS.VERSION_KEY + "=" + VERSION;
		...
		params.putString(CLIENTLOGIN_PARAMETERS.REGISTSERVICE_KEY, registService);
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> register(int updataId, String email, String mobile, String password, String nickname,
			String gender, String registService, String vcode, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl() + "?" + PUBLIC_PARAMETERS.MOD_KEY + "=" + ADDUSER_PARAMETERS.MOD_VALUE + "&" + PUBLIC_PARAMETERS.CTL_KEY + "="
				+ ADDUSER_PARAMETERS.CTL_VALUE + "&" + PUBLIC_PARAMETERS.ACT_KEY + "=" + ADDUSER_PARAMETERS.ACT_VALUE + "&" + PUBLIC_PARAMETERS.PCODE_KEY + "="
				+ PCODE + "&" + PUBLIC_PARAMETERS.VERSION_KEY + "=" + VERSION;
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> sendActiveEmail(int updataId, String email, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, SENDACTIVEEMAIL_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, SENDACTIVEEMAIL_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, SENDACTIVEEMAIL_PARAMETERS.ACT_VALUE);
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> checkMobileExists(int updataId, String mobile, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, CHECKMOBILEEXISTS_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, CHECKMOBILEEXISTS_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, CHECKMOBILEEXISTS_PARAMETERS.ACT_VALUE);
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> checkEmailExists(int updataId, String email, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, CHECKEMAILEXISTS_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, CHECKEMAILEXISTS_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, CHECKEMAILEXISTS_PARAMETERS.ACT_VALUE);
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> sendBackPwdEmail(int updataId, String email, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, SENDBACKPWDEMAIL_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, SENDBACKPWDEMAIL_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, SENDBACKPWDEMAIL_PARAMETERS.ACT_VALUE);
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> modifyPwd(int updataId, String tk, String oldpwd, String newpwd, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl() + "?" + PUBLIC_PARAMETERS.MOD_KEY + "=" + MODIFYPWD_PARAMETERS.MOD_VALUE + "&" + PUBLIC_PARAMETERS.CTL_KEY + "="
				+ MODIFYPWD_PARAMETERS.CTL_VALUE + "&" + PUBLIC_PARAMETERS.ACT_KEY + "=" + MODIFYPWD_PARAMETERS.ACT_VALUE + "&" + PUBLIC_PARAMETERS.PCODE_KEY
				+ "=" + PCODE + "&" + PUBLIC_PARAMETERS.VERSION_KEY + "=" + VERSION;
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> s_sendMobile(int updataId, String mobile, LetvMainParser<T, D> parser) {
		String baseUrl = getDynamicUrl();

		Bundle params = new Bundle();
		params.putString(PUBLIC_PARAMETERS.MOD_KEY, S_SENDMOBILE_PARAMETERS.MOD_VALUE);
		params.putString(PUBLIC_PARAMETERS.CTL_KEY, S_SENDMOBILE_PARAMETERS.CTL_VALUE);
		params.putString(PUBLIC_PARAMETERS.ACT_KEY, S_SENDMOBILE_PARAMETERS.ACT_VALUE);
	...
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestFocusMatch(int updataId,String matchId,String level,String flag,
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestFocusPic(int updataId,
			LetvBaseParser<T, D> parser) {
		...
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, FOCUS_PIC.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, FOCUS_PIC.CTL_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, FOCUS_PIC.ACT_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.PCODE_KEY, PCODE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.VERSION_KEY, VERSION));
	 ...
	 * @return
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestListVideo(int updataId,String sc,String pn,String ps,String or,
			LetvBaseParser<T, D> parser) {
		...
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, LIST_VIDEO.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, LIST_VIDEO.CTL_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, LIST_VIDEO.ACT_VALUE));
	 ...
	 * 视频新闻筛选类型
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestVideoTypes(int updataId,
			LetvBaseParser<T, D> parser) {
		...
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, VIDEO_TYPES.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, VIDEO_TYPES.CTL_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, VIDEO_TYPES.ACT_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.PCODE_KEY, PCODE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.VERSION_KEY, VERSION));
	 ...
	 * 视频相关新闻
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestVideoList(int updataId, String id, String vid, String pn, String ps,
			LetvBaseParser<T, D> parser) {
		...
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.MOD_KEY, VIDEO_LIST.MOD_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.CTL_KEY, VIDEO_LIST.CTL_VALUE));
		params.add(new BasicNameValuePair(PUBLIC_PARAMETERS.ACT_KEY, VIDEO_LIST.ACT_VALUE));
	...
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestMatchesRemind(int updataId,
			LetvBaseParser<T, D> parser) {
	 ...
	 * 发表评论
	 */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestAddComment(int updataId,
			LetvBaseParser<T, D> parser,String vid,String content) {
		...
		params.putString(ADD_COMMENT.TOKEN, PreferencesManager.getInstance().getSso_tk());
	...
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestGetComment(int updataId,
			LetvBaseParser<T, D> parser,String vid,String pn,String ps) {
		...
		params.putString(GET_COMMENT.TOKEN, PreferencesManager.getInstance().getSso_tk());
		params.putString(GET_COMMENT.UID, PreferencesManager.getInstance().getUserId());
	 ...
	 * @return XDataHull<T> 壳数据
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestFeedBack(int updataId, String devid, String name, String sysname, String sysver,
			String model, String lmodel, String feedback, String sex, String agegroup, LetvMainParser<T, D> parser) {
		 ...
		 * 
		 */
		String baseUrl = getDynamicUrl() + "?" + PUBLIC_PARAMETERS.MOD_KEY + "=" + FEEDBACK_PARAMETERS.MOD_VALUE + "&" + PUBLIC_PARAMETERS.CTL_KEY + "="
				+ FEEDBACK_PARAMETERS.CTL_VALUE + "&" + PUBLIC_PARAMETERS.ACT_KEY + "=" + FEEDBACK_PARAMETERS.ACT_VALUE + "&" + PUBLIC_PARAMETERS.PCODE_KEY
				+ "=" + PCODE + "&" + PUBLIC_PARAMETERS.VERSION_KEY + "=" + VERSION;
		Bundle params = new Bundle();
		...
		{// 加密字段
			...
			params.putString(FEEDBACK_PARAMETERS.SIGN_KEY, MD5.toMd5(sb.toString()));
		}
       ...
       *  通过视频id获取视频或专辑详情
       * */
      public static <T extends LetvBaseBean, D> LetvDataHull<T> requestGetAlbumById(int updataId, String id, LetvMainParser<T, D> parser) {
            String head = getStaticHead();
            String end = getStaticEnd();
	 ...
	 * 请求开机广告图接口	
	 * */
	public static <T extends LetvBaseBean, D> LetvDataHull<T> requestGetPushAd(int updataId,
			LetvBaseParser<T, D> parser) {

		LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(WB_STATIC_PUSH_AD_IMAGE, null, LetvHttpParameter.Type.GET, parser, updataId);

		return request(httpParameter);
	}

      public static <T extends LetvBaseBean, D> LetvDataHull<T> requestShowWorldCup(int updataId, LetvBaseParser<T, D> parser) {
            String url = String.format(getWorldCupUrl(), LetvUtil.getClientVersionName(), LetvUtil.getPcode());
            LetvHttpParameter<T, D> httpParameter = new LetvHttpParameter<T, D>(url, null, LetvHttpParameter.Type.GET, parser, updataId);
            return request(httpParameter);
      }
}
